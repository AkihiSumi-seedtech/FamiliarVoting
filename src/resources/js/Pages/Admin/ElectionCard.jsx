...
const ElectionCard = () => {
  return (
<button id="main" class="p-2 justify-around ml-32 h-48 w-3/4 flex items-start flex items-center bg-white-200 border-solid border-2 border-bg-slate-500 rounded-lg">
    <div>
